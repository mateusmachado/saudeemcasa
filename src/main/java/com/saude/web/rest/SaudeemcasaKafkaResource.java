...
@RestController
@RequestMapping("/api/saudeemcasa-kafka")
public class SaudeemcasaKafkaResource {
    private final Logger log = LoggerFactory.getLogger(SaudeemcasaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SaudeemcasaKafkaResource(KafkaProperties kafkaProperties) {
